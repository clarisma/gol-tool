 ...
 */
public class Analyzer2 extends OsmPbfReader
{
     ...
     */
    private int stringBatchSize = 64 * 1024;  // TODO: was 64

    public Analyzer2(Project project)
    {
    ...
    private class AnalyzerThread extends WorkerThread
    {
        ...
        {
            strings = new ObjectIntHashMap<>(stringBatchSize);
            stringCounts = new int[stringBatchSize * 3];
        }

        private void killWeakestStrings()
        {
            final int minOccurrence = 2;
            strings = strings.reject((s, row) ->
            {
                int p = row * 3;
                int total = stringCounts[p] + stringCounts[p+1] + stringCounts[p+2];
                return total < minOccurrence;
            });
        }
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        Analyzer2 analyzer = new Analyzer2(project);
