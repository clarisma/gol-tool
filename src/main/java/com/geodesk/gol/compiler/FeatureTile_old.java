...
//
//
//    public FeatureTile_old(int tile, ObjectIntMap<String> globalStrings,
//        TileCatalog tileCatalog, Config config)
//    {
//        this.tile = tile;
...
//    {
//        return SIndexTree.build(id, features, tileBounds, config);
//    }
//
